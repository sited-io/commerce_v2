...
// @generated from file sited_io/query/v1/query.proto (package sited_io.query.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum sited_io.query.v1.Direction
 */
...
proto3.util.setEnumType(Direction, "sited_io.query.v1.Direction", [
...
/**
 * @generated from message sited_io.query.v1.PaginationRequest
 */
export class PaginationRequest extends Message<PaginationRequest> {
  ...
  static readonly typeName = "sited_io.query.v1.PaginationRequest";
...
/**
 * @generated from message sited_io.query.v1.PaginationResponse
 */
export class PaginationResponse extends Message<PaginationResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "sited_io.query.v1.PaginationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "page", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
    { no: 2, name: "size", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
