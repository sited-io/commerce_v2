        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/sited_io.media.v2.MediaService/UploadFile",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sited_io.media.v2.MediaService", "UploadFile"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sited_io.media.v2.MediaService/DeleteFile",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sited_io.media.v2.MediaService", "DeleteFile"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod media_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sited_io.media.v2.MediaService/UploadFile" => {
                    ...
                    struct UploadFileSvc<T: MediaService>(pub Arc<T>);
                    impl<
                        T: MediaService,
                    ...
                    for UploadFileSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as MediaService>::upload_file(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/sited_io.media.v2.MediaService/DeleteFile" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteFileSvc<T: MediaService>(pub Arc<T>);
                    impl<
                        T: MediaService,
                    ...
                    for DeleteFileSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MediaService>::delete_file(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "sited_io.media.v2.MediaService";
